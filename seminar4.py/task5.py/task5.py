...
# файл первый:AAAAAAAAAAAABBBBBBBBBBBCCCCCCCCCCDDDDDDEEEEEFFFFG python is sooooooo coooooool
# файл второй:12A11B10C6D5E4FG python is s7o c7ol
...
print('Строка декодирования: \t' + decoded_string)
print('Кодирующая строка: \t' + rle_encode(decoded_string))
# print(f'Коэфффшциэнт сжатия: \t{round(len(decoded_string) / len(encoded_string), 1)}')