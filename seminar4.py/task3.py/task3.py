...
with open('list_stydents.txt', 'w', encoding='utf-8') as file_spisok:
...
file_spisok = open('list_stydents.txt', 'r', encoding='utf-8') # encoding='utf-8', 
lines_spisok = file_spisok.read().split('\n')
file_spisok.close()

spisok_new = change_spisok(lines_spisok, accept='5')

file_spisok = open('list_stydents_new.txt', 'w', encoding='utf-8')
file_spisok.write(spisok_new)
file_spisok.close()

path = 'list_stydents_new.txt'
file_spisok = open(path, 'r', encoding='utf-8')
